                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={6}>
                                <TextField
                                    ...
                                    helperText={errors.expAddr || "Block explorer URL template for addresses (e.g. 'https://etherscan.io/address/{{address}}')"}
                                />
                            </Grid>
                            ...
                            <Grid item xs={12} md={6}>
                                <TextField
                                    ...
                                    onChange={handleChange}
                                    error={!!errors.expTx}
                                    helperText={errors.expTx || "Block explorer URL template for transactions (e.g. 'https://etherscan.io/tx/{{hash}}')"}
                                />
                            </Grid>
