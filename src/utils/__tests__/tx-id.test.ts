...
describe('tx-id utils', () => {
  it('normalizes multisig tx ids to lowercase', () => {
    expect(
      normalizeTxId('multisig_0xA710c854edE0eEaF84eA272363083cfA547dd552_0xAbCdEf1234567890'),
    ).toBe('multisig_0xa710c854ede0eeaf84ea272363083cfa547dd552_0xabcdef1234567890')
  })
